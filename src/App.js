      ...
      <div className='row'>
        ...
        <div className='col-md-8 mx-auto lightBox p-5 mt-5 mb-5'>
          ...
          <div className='text-center'>
            ...
            <span className='mx-2 bg-dark rounded-2 border-0  text-white p-2'>{time}</span>
            <button className='me-2 p-2 rounded-2 border-0 text-white hover' onClick={handleReset}>
